    ...
    public List<TableInfo> getTables() {
        ...
        try {
            ...
            while (tableResults.next()) {
                ...
                for (String splitTableName : Constants.TABLE_SPLIT) {
                    if (tableName.startsWith(splitTableName) && !tableName.equals(splitTableName)) {
                        splitTable = true;
                        break;
                    }
                }
                ...
                //处理xml表名
                if (Constants.TABLE_SPLIT.contains(tableName)) {
